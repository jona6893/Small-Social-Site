  ...
  return (
    <section className="mx-auto w-full max-w-screen-xl">
      <form
        onSubmit={handelPost}
        action=""
        className="md:p-8 p-4 sm:w-2/3 mx-auto drop-shadow bg-white flex flex-col gap-4 items-end rounded-lg"
      >
        <textarea
          name="postContent"
          placeholder="lorem..."
          className="block  mt-2 w-full placeholder-gray-400/70 dark:placeholder-gray-500 rounded-lg border border-gray-300 bg-white px-4 h-20 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300"
        ></textarea>
        <div className="flex gap-2 justify-between w-full">
          ...
          />
          <button
            className="w-fit shadow-xl py-2.5 px-8 text-sm font-semibold rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none"
            type="submit"
          >
            Post
          </button>
